...
ios)
    ...
    #mydo cordova build ios --device --release  --codeSignIdentity=$IOS_DEVELOPER_NAME
        echo "### cordova build ios"; cordova build ios --device --release  --codeSignIdentity="iPhone Developer" --developmentTeam=CU6FE4TYC9 --provisioningProfile=$HOME/Library/MobileDevice/Provisioning\ Profiles/learnLang.mobileprovision
