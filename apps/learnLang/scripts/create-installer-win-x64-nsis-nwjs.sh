...
$APPL_DIR/node_modules/.bin/makensis-cli compile ./create-installer-win-x64-nsis-nwjs$debug.nsi >create-installer-win-x64-nsis-nwjs$debug.out.txt 2>&1
mydo cat create-installer-win-x64-nsis-nwjs$debug.out.txt --mydo-tail-20
